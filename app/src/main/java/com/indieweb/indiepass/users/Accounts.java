...
import com.indieweb.indiepass.LaunchActivity;
...
public class Accounts {
    ...
    public User getDefaultUser() {
        ...
        SharedPreferences preferences = context.getSharedPreferences("indiepass", MODE_PRIVATE);
    ...
    public void switchAccount(final Activity activity, final User user, final RelativeLayout layout) {
        ...
        builder.setPositiveButton(context.getString(R.string.switch_account),new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog,int id) {
                ...
                SharedPreferences.Editor editor = context.getSharedPreferences("indiepass", MODE_PRIVATE).edit();
