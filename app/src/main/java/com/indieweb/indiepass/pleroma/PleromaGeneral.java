package com.indieweb.indiepass.pleroma;

import android.content.Context;

import com.indieweb.indiepass.GeneralBase;
import com.indieweb.indiepass.MainActivity;
import com.indieweb.indiepass.R;
import com.indieweb.indiepass.model.User;

import java.util.ArrayList;

public class PleromaGeneral extends GeneralBase {

    public PleromaGeneral(Context context, User user) {
        super(context, user);
    }
