package com.indieweb.indiepass.indieweb.microsub;

import android.content.Context;
import android.content.Intent;

import com.android.volley.Request;
import com.indieweb.indiepass.IndiePass;
...
import com.indieweb.indiepass.post.ContactActivity;
import com.indieweb.indiepass.post.LikeActivity;
import com.indieweb.indiepass.post.RepostActivity;
import com.indieweb.indiepass.reader.Reader;
import com.indieweb.indiepass.reader.ReaderBase;
...
import static com.indieweb.indiepass.util.Utility.getSingleJsonValueFromArrayOrString;
import static com.indieweb.indiepass.util.Utility.checkReference;
    ...
    public List<TimelineItem> parseTimelineResponse(String response, String channelId, String channelName, List<String> entries, boolean isGlobalUnread, boolean isSearch, boolean recursiveReference, String[] olderItems) {
        ...
        try {
            ...
            for (int i = 0; i < itemList.length(); i++) {
                ...
                //Log.d("indiepass_debug", "text before: " + item.getTextContent());
                //Log.d("indiepass_debug", "html before: " + item.getHtmlContent());
                //Log.d("indiepass_debug", "reference before: " + item.getReference());
                ...
                if (item.swapReference() && item.getReference().length() > 0 && Preferences.getPreference(getContext(), "pref_key_timeline_author_original", false) && textContent.length() == 0 && htmlContent.length() == 0) {
                    //Log.d("indiepass_debug", "swapping ref / content");
                ...
                //Log.d("indiepass_debug", "text after: " + item.getTextContent());
                //Log.d("indiepass_debug", "html after: " + item.getHtmlContent());
                //Log.d("indiepass_debug", "reference after: " + item.getReference());
