package com.indieweb.indiepass.db;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "indiepass";
    ...
    public Cache getCache(String account, String type, String channelId, String page) {
        ...
        Log.d("indiepass_debug", "All caches: " + count);
        String selectQuery = "SELECT * FROM " + Cache.TABLE_NAME;
        Cursor all = db.rawQuery(selectQuery, null);
        if (all.moveToFirst()) {
            do {
                Log.d("indiepass_debug", "Cache: " + all.getInt(all.getColumnIndexOrThrow(Cache.COLUMN_ID)) + " - " + all.getString(all.getColumnIndexOrThrow(Cache.COLUMN_TYPE)));
